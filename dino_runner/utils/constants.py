...
# Assets Constants
ICON = pygame.image.load(os.path.join(IMG_DIR, "Dino/DinoRun1Hammer.png"))
DINOD = pygame.image.load(os.path.join(IMG_DIR, "Dino/DinoDead.png"))
RESTART_ICON = pygame.image.load(os.path.join(IMG_DIR, "Other/Reset.png"))
